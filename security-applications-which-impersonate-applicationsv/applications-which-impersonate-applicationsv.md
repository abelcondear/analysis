# Applications which impersonate Applications

When we install an application from Google Play Store, we should be aware that it is not the only application that we can install. Besides, application can be installed manually. 
